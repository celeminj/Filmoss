...
import peliculasNuevasCRUD from './components/CRUD/peliculasNuevasCRUD.vue';
import eventosCRUD from './components/CRUD/eventosCRUD.vue';
import peliculasCRUD from './components/CRUD/peliculasCRUD.vue';
import mapa from './components/map.vue';
import cinesCRUD from './components/CRUD/cinesCRUD.vue';
import navDesplegable from './components/navDesplegable.vue';
import actorCRUD from './components/CRUD/actorCRUD.vue';
...
import categoriaCURD from './components/CRUD/categoriaCURD.vue';
...
import paradax from './components/PARADAX/paradax.vue';
const app = createApp({});
