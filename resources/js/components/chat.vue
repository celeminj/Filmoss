<template>
    ...
    <div id="chat-lateral" :style="{ right: chatAbierto ? '0' : '-400px' }">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <h3>Live chat</h3>
            <button id="cerrar-chat" @click="cerrarChat"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="20" height="20" viewBox="0,0,256,256" style="fill:#40C057;">
        ...
        <div class="enviar-chat">
            <div class="input-group mb-3">
                <input v-model="nuevoMensaje" @keypress.enter.prevent="enviarMensaje" type="text" class="form-control"
...
const cargarMensajes = () => {
    try {
        const response = axios.get(`/pelicula_nueva/${props.peliculaId}/${props.hora}/${props.eventoId}/chat`);
...
const enviarMensaje = () => {
    ...
    try {
        const response = axios.post(`/pelicula_nueva/${props.peliculaId}/${props.hora}/${props.eventoId}/chat`, {
